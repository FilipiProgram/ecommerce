    ...
    public static function verifyLogin($inadmin = true)
        ...
        public static function getForgot($email)
        {
            ...
            else
            {
				...
				$link = "http://www.virtuecommerce.com.br/admin/forgot/reset?code=$code";

                    $mailer = new Mailer($data["desemail"], $data["desperson"], "Redefinir Senha da Virtues Imports", "forgot", 
        ...
        
        {
            ...
            $iv = mb_substr($result, openssl_cipher_iv_length('aes-256-cbc'), '8bit');
